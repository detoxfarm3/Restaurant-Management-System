...
class ProductSkuAutoComplete extends React.Component {
    constructor(props) {
        super(props);
    ...
    loadSuggestions(value) {
        ...
        const suggestions = getMatchingProductsBySku(value, this.props.products || []);
...
ProductSkuAutoComplete.defaultProps = {
...
function getMatchingProductsBySku(value, products) {
    ...
    return products.filter(product => regex.test(product.sku || ''));
}

module.exports = ProductSkuAutoComplete;